...
import { getFoods, getDrinks, getCombos } from "../../redux/actions";
    ...
    {/* <button onClick={()=> console.log(url)}>click me</button> */}
      <div className="container-foods">
        <div className="buttons-foods">
          <div
            className={`button-combos ${selected === "combos" && "selected"}`}
            onClick={() => handleClickFood("combos")}
          >
            Combos
          </div>
          <div
            className={`button-foods ${selected === "foods" && "selected"}`}
            onClick={() => handleClickFood("foods")}
          >
            Pop-Corn and Food
          </div>
          <div
            className={`button-drinks ${selected === "drinks" && "selected"}`}
            onClick={() => handleClickFood("drinks")}
          >
            Drinks
          </div>
        </div>
