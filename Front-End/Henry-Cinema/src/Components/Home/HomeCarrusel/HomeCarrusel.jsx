...
export default function HomeCarrusel({ cartelera }) {
  ...
  function playpause() {
    if (document.getElementById("btnPauseHome")) {
      ...
      if (tiempo == null) {
        boton.src =
          "https://www.pngmart.com/files/3/Pause-Button-Transparent-Background.png";
        tiempo = setInterval(() => {
          Next();
        }, velocidad);
      } else {
        ...
        tiempo = null;
        boton.src =
          "https://static.vecteezy.com/system/resources/previews/001/200/436/original/music-player-button-play-png.png";
      }
    }
  }
      ...
      <div className="contenedorCarrusel">
        <div className="Carrusel">
          {cartelera.map((data, index) => {
            ...
            if (index == 0) {
              name = "carteleraHome actual";
            }
            return (
              <div key={data.apiId} className={name}>
                <Link to={`/showscreenings/${data.id}`}>
          ...
          <div className="botonPause">
            <img
              src="https://www.pngmart.com/files/3/Pause-Button-Transparent-Background.png"
              id="btnPauseHome"
              onClick={() => playpause()}
            />
          </div>
